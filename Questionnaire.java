...
public class Questionnaire extends Activity implements View.OnClickListener{
    ...
    RatingBar ratingBar5 = (RatingBar)findViewById(R.id.ratingBar2);
    RatingBar ratingBar6 = (RatingBar)findViewById(R.id.ratingBar3);
    RatingBar ratingBar7 = (RatingBar)findViewById(R.id.ratingBar);
    RatingBar ratingBar8 = (RatingBar)findViewById(R.id.ratingBar2);
    RatingBar ratingBar9 = (RatingBar)findViewById(R.id.ratingBar3);
    RatingBar ratingBar10 = (RatingBar)findViewById(R.id.ratingBar);
    RatingBar ratingBar11 = (RatingBar)findViewById(R.id.ratingBar2);
    RatingBar ratingBar12 = (RatingBar)findViewById(R.id.ratingBar3);
    RatingBar ratingBar13 = (RatingBar)findViewById(R.id.ratingBar);
    RatingBar ratingBar14 = (RatingBar)findViewById(R.id.ratingBar2);
    RatingBar ratingBar15 = (RatingBar)findViewById(R.id.ratingBar3);
    RatingBar ratingBar16 = (RatingBar)findViewById(R.id.ratingBar);
    RatingBar ratingBar17 = (RatingBar)findViewById(R.id.ratingBar2);
    RatingBar ratingBar18 = (RatingBar)findViewById(R.id.ratingBar3);
    RatingBar ratingBar19 = (RatingBar)findViewById(R.id.ratingBar);
    RatingBar ratingBar20 = (RatingBar)findViewById(R.id.ratingBar2);
